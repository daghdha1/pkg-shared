...
exports.MysqlKnexProvider = exports.queryBuilder = void 0;
const knex_1 = __importDefault(require("knex"));
exports.queryBuilder = (0, knex_1.default)({
    client: 'mysql2',
    useNullAsDefault: false,
});
const MysqlKnexProvider = async (config) => {
...
exports.MysqlKnexProvider = MysqlKnexProvider;
//# sourceMappingURL=MysqlKnexProvider.js.map